<h3 class="page-header-form-list">Cadastro de Categoria de Produtos</h3>
...
<form action="<?php echo site_url('privado/categoriasprodutos/lista'); ?>" method="post" class="form-horizontal" role="form">       
    <div class="form-group">
        ...
        <div class="col-xs-8 col-sm-4 col-md-4 col-lg-2">
            <input id="itId" name="itId" type="text" maxlength="90" value="<?php echo $dadosCategoriasProduto['id'];?>" class="form-control" readonly=""/>
        </div>
    </div>
    <div class="form-group">
        <label for="itNome" class="col-sm-2 control-label">Nome:</label>
        <div class="col-sm-6">
            <input id="itNome" name="itNome" type="text" maxlength="90" value="<?php echo $dadosCategoriasProduto['nome'];?>" class="form-control"/>
        </div>
    </div>    
    <div class="form-group">
